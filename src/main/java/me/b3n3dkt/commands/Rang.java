                ...
                if(args[0].equalsIgnoreCase("set")){
                    if(MySQL.isRegistered(offlinetarget.getUniqueId().toString())){
                        if(rang.equalsIgnoreCase("spieler")){
                            ...
                            sender.sendMessage(SkyPvP.getPrefix() + "§7Der Spieler §8'§e" + offlinetarget.getName() + "§8' §7hat nun den Rang §8'§9Freund/in§8'§7.");
                            MySQL.setRang(uuid, "freund");
                        }else if(rang.equalsIgnoreCase("youtuber")){
                            setRank((Player) offlinetarget, "youtuber");
                            sender.sendMessage(SkyPvP.getPrefix() + "§7Der Spieler §8'§e" + offlinetarget.getName() + "§8' §7hat nun den Rang §8'§4§lYou§f§lTuber§8'§7.");
                            MySQL.setRang(uuid, "youtuber");
                        }else if(rang.equalsIgnoreCase("streamer")){
                            setRank((Player) offlinetarget, "streamer");
                            sender.sendMessage(SkyPvP.getPrefix() + "§7Der Spieler §8'§e" + offlinetarget.getName() + "§8' §7hat nun den Rang §8'§d§lStreamer§8'§7.");
